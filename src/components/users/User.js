...
const User = ({ getUser, getUserRepos, loading, match, repos, user }) => {
    // use useEffect w/empty brackets to replace componentDidMount fn (note eslint command ti disable warning)
    useEffect(() => {
